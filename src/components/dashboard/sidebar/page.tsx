...
//   const [ setNotifications] = useState<NotificationsState>({});
...
//     return (
//       <span className={cn(
//         'ml-auto text-black text-xs rounded-full px-2 py-0.5',
...
//                 NotificationService.getInstance().clearNotification(item.path);
//               }
//             }
//           }}
//           className={cn(
...
//           {/* Notification Badge */}
//           {!isCollapsed && <NotificationBadge notification={item.notifications} />}
//         </motion.div>
  
//         {/* Dropdown items rendering remains the same */}
//         <AnimatePresence>
...
//                 >
//                   {subItem.label}
//                   {subItem.notifications && <NotificationBadge notification={subItem.notifications} />}
//                 </div>
//               ))}
//             </motion.div>
//           )}
...
//       </div>
//     );
//   }, [currentPath, isCollapsed, openDropdown, toggleDropdown, onNavigate]);
