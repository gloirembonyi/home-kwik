...
const ProfileTab: React.FC<ProfileTabProps> = ({ userData, onUpdateProfile }) => {
  ...
  const handleSave = useCallback(async () => {
    ...
    if (!validateEmail(formData.email)) validationErrors.push("Invalid email address");
    if (!validatePhone(formData.phone)) validationErrors.push("Invalid phone number");
