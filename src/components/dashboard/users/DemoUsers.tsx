...
//         prevUsers.map((user: { id: number; phoneNumber: any; gender: any }) =>
...
//     setUsers((prevUsers: any[]) =>
//       prevUsers.filter((user: { id: number }) => user.id !== userId)
//     );
//   }, []);
...
//     setUsers((prevUsers: any[]) =>
//       prevUsers.filter(
//         (user: { id: number }) => !selectedUsers.includes(user.id)
//       )
//     );
//     setSelectedUsers([]);
//   }, [selectedUsers]);

//   const renderViewUserModal = () => {
...
//                 setNewUser((prev) => ({
//                   ...prev,
//                   role: e.target.value as "Driver" | "Rider",
//                 }))
//               }
//               className="w-full p-3 border rounded"
//             >
...
//       {/* Modals */}
//       {isViewUserModalOpen && renderViewUserModal()}
...
// function setUsers(arg0: (prevUsers: any[]) => ({ id: number; phoneNumber: any; gender: any; } | { name: string; email: string; role: string; phoneNumber: any; gender: any; id: number; })[]) {
